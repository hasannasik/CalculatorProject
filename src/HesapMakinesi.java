...
public class HesapMakinesi implements ActionListener {
    ...
    HesapMakinesi() {
        frame =new JFrame("HesaspMakinesi");
        ...
        funcitonButtons[0] = addButton;
        funcitonButtons[1] = subButton;
        funcitonButtons[2] = mulButton;
        funcitonButtons[3] = divButton;
        funcitonButtons[4] = decButton;
        funcitonButtons[5] = equButton;
        funcitonButtons[6] = delButton;
        funcitonButtons[7] = clrButton;
        funcitonButtons[8] = negButton;

        for(int i = 0 ; i < 9 ; i++ )
        {
            funcitonButtons[i].addActionListener(this);
            funcitonButtons[i].setFont(myFont);
